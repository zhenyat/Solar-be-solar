...
group :development, :test do
  gem 'byebug', platforms: [:mri, :mingw, :x64_mingw] # Ruby 2 debugger. Call 'byebug' anywhere in the code to stop execution and get a debugger console                                                     # https://github.com/deivid-rodriguez/byebug
end
