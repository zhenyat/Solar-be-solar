class Admin::CompaniesController < Admin::BaseController
  ...
  private
    ...
    def company_params
      params.require(:company).permit(:name, :title, :inn, :ogrnip, :certificate_number, :certificate_date, :email, :phone, :legal_address, :pickup_address, :url, :comment, :status, :seo_title, :seo_description, :seo_keywords)
    end
end
