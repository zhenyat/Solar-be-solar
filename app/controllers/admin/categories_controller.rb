class Admin::CategoriesController < Admin::BaseController
  ...
  private
    ...
    def category_params
      params.require(:category).permit(:name, :title, :abstract, :position, :visibility, :status, :url, :comment, :seo_title, :seo_description, :seo_keywords, :ancestry, :content, :cover_image, :remove_cover_image, images: [])
    end
end
